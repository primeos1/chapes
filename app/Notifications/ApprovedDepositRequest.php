...
class ApprovedDepositRequest extends Notification {
    use Queueable;
    ...
    public function __construct($transaction) {
        ...
        $this->template    = EmailSMSTemplate::where('slug', 'DEPOSIT_REQUEST_APPROVED')->first();
        ...
        $this->replace['depositMethod'] = $this->transaction->deposit_request->method->name;
    }
