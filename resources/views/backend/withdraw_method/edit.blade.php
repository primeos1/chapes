					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" name="minimum_amount" value="{{ $withdrawmethod->minimum_amount }}" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control float-field" name="maximum_amount" value="{{ $withdrawmethod->maximum_amount }}" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="fixed_charge" value="{{ $withdrawmethod->fixed_charge }}" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="input-group mb-3">
									<input type="text" class="form-control" name="charge_in_percentage" value="{{ $withdrawmethod->charge_in_percentage }}" required>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<textarea class="form-control" name="descriptions">{{ $withdrawmethod->descriptions }}</textarea>
							</div>
						</div>
